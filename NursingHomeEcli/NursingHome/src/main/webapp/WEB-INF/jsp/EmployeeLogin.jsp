...
<html>
   ...
   <body>
      ...
      <div class="content">
         ...
         <sf:form modelAttribute="defEmpInfo">
            <div>
               <label for="validatonDefault01">Designation</label>
               <sf:select path="designation" class="custom-select mr-sm-2" id="validatonDefault01">
