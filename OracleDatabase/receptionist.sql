...
SET DEFINE OFF;
Insert into SYSTEM.RECEPTIONIST_NURSING_HOME (RECEPTIONIST_USER_ID,PASSWORD,EMPLOYEE_ID) values ('a9','%b7U5K{mJ8;2~Kaj','E9');
Insert into SYSTEM.RECEPTIONIST_NURSING_HOME (RECEPTIONIST_USER_ID,PASSWORD,EMPLOYEE_ID) values ('a18','K3L%PuUA{e5\b#SK','E18');
Insert into SYSTEM.RECEPTIONIST_NURSING_HOME (RECEPTIONIST_USER_ID,PASSWORD,EMPLOYEE_ID) values ('a25','A7d(N<t^LTYj`$wq','E25');
--------------------------------------------------------
