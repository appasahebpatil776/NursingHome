...
<li class="nav-item dropdown">
   ...
   <li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="/home/adminDashboard/addSchedule" role="button" aria-haspopup="true" aria-expanded="false">Schedule</a>
    <div class="dropdown-menu">
      <a class="dropdown-item" href="/home/adminDashboard/viewSchedule">View Schedule</a>
        </div>
  </li>
  <li class="nav-item dropdown">
